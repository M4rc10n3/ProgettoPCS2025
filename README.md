...
- `b` and `c` define the parameters for the tessellation, following Magnus Wenniger notation {p, q+}<sub>(b,c)</sub>, determining the number of subdivisions of the faces of the starting polyhedron and the complexity of the mesh on them.
